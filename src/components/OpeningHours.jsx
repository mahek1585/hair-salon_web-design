    ...
    <section className="relative w-full h-[43.75rem] bg-[#F4EDE6] flex items-center justify-center">
      ...
      <div className="flex flex-col justify-center h-full ">
        ...
        <div className="pl-[6.37rem]">
          <button className="text-white bg-black py-[0.5rem] px-[2rem] font-montesrrat font-semibold text-[1rem] leading-[2.25rem] tracking-[0.12em] uppercase hover:bg-emerald-50 hover:text-black transition hover:cursor-pointer">
            Book Now
          </button>
        </div>
      </div>
